...
// NEW Day 11: Admin creates a new badge
...
// NEW Day 11: Admin deletes a badge
// Also removes all userBadge records for it
// =========================================
router.delete("/badges/:id", requireAuth, requireAdmin, async (req, res) => {
  try {
    ...
    // Remove all awards first to avoid FK violation
...
// NEW Day 11: Enrollment trends — last 14 days
...
// NEW Day 11: Quiz pass/fail stats per course
// =========================================
...
// NEW Day 11: Revenue summary per course
// =========================================
